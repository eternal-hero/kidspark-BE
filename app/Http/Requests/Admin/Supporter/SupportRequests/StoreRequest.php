...
namespace App\Http\Requests\Admin\Supporter\SupportRequests;
...
class StoreRequest extends CustomFormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'is_handicapped_children_approval' => ['required', Rule::in([0, 1])],
            'is_handicapped_children_support' => ['nullable', Rule::in([0, 1])],
